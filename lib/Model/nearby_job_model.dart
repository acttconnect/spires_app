...
NearbyJobModel nearbyJobModelFromJson(String str) =>
    NearbyJobModel.fromJson(json.decode(str));
String nearbyJobModelToJson(NearbyJobModel data) => json.encode(data.toJson());
...
class NearbyJobModel {
  ...
  NearbyJobModel.fromJson(dynamic json) {
    _error = json['error'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
